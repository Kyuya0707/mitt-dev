...
const FAQ_ITEMS: FaqEntry[] = [
  ...
  {
    q: "質問はどのように投稿しますか？",
    a: "質問内容、カテゴリ、報酬金額、BEST閲覧料に加えて、必要に応じて回答期限も入力して投稿します。必要に応じて画像も添付できます。決済が完了すると質問が公開され、回答が集まったら質問者がBEST回答を選びます。",
  },
  {
    q: "回答はどのように投稿しますか？",
            ...
            <div className="mt-12">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                <StepCard
                  step="STEP 1"
                  title="質問する"
                  desc="回答者への報酬を設定して質問します。必要に応じて回答期限も設定でき、期限を過ぎるとキャンセル申請が可能になります。背景や比較したことまで書くほど、良い回答が集まりやすくなります。"
                  delay={0.05}
                />
                <StepCard
                  step="STEP 2"
